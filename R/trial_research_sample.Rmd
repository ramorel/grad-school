---
title: "Qualifying paper with Toy Data"
...
My qualifying paper uses data that I cannot publicly share. (It is now published [here](https://journals.sagepub.com/doi/full/10.3102/0002831218788528)). So I will use a publicly available set to demonstrate this code. The `ergm` pack has a number of sample social networks. First, load the relevant libraries.
